...
const Ebook = () => {
    return (
        <section className="w-full h-screen py-4">
            <div className="h-full bg-second bg-cover bg-mobile-position-second md:bg-contain md:bg-left md:bg-no-repeat xl:bg-desktop-position-second">

                <div className="h-full flex">
                    <div className="flex flex-col justify-end md:items-end xl:items-center xl:ml-[40%]">
                        <h1 className="text-white uppercase font-rowdies text-center text-2xl md:text-3xl xl:text-[2.5rem] md:w-[45%] xl:w-[40%]">
                            O que você <br className="md:hidden xl:block" />vai Receber:
                        </h1>
                        <h2 className="p-4 text-white uppercase text-center font-kulim md:text-3xl xl:text-[2.5rem] md:w-[45%] md:flex-grow xl:w-[100%] xl:pl-[20%] xl:pt-[10%] xl:pr-10 xl:text-start">
